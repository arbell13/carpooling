...
--
-- Host: 127.0.0.1
-- Generation Time: May 04, 2023 at 08:01 AM
...
INSERT INTO `tblcardetails` (`cardetailsID`, `driverID`, `plateNumber`, `type`) VALUES
(23, 5, 'BK 1023', 'Van'),
(24, 1, 'HW 5531', 'SUV '),
(25, 3, 'KK 1111', 'Minivan'),
(26, 8, 'CDB 643', 'Minivan'),
(27, 9, 'UBT 465', 'SUV'),
(28, 4, 'CJA 910', 'Universal'),
(29, 7, 'TTC 381', 'Van '),
(30, 6, 'GPE 277', 'Minivan'),
(31, 2, 'ABC 3158', 'Universal'),
(32, 4, 'WPZ 225', 'SUV'),
(40, 21, 'test', 'test');
...
(32, 'Driver', 'test', 'test', 'test', 'test', 'test', 'test', 'test', '123132', 'test123@gmail.com', 'test1234', 'verify');
...
--
ALTER TABLE `tblcardetails`
  MODIFY `cardetailsID` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=41;
